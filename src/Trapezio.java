...
public class Trapezio extends JFrame {
	...
	public Trapezio() {
		...
		JLabel lblNewLabel = new JLabel("Trap\u00E9zio");
		lblNewLabel.setForeground(new Color(255, 255, 255));
		lblNewLabel.setFont(new Font("Poppins", Font.BOLD, 20));
		lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel.setBounds(305, 10, 204, 60);
		...
		JLabel lblNewLabel_3 = new JLabel("Digite a base menor (b)");
		...
		cx2.setColumns(10);
		cx2.setBounds(610, 184, 205, 40);
		panel.add(cx2);
		
		cx3 = new JTextField();
		cx3.setFont(new Font("Poppins", Font.BOLD, 20));
		cx3.setColumns(10);
		cx3.setBounds(610, 234, 205, 40);
		panel.add(cx3);
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if((cx1.getText().equals("") || cx2.getText().equals("") || cx3.getText().equals("")) ||
						(cx1.getText().equals(" ") || cx2.getText().equals(" ") || cx3.getText().equals(" "))) {
					JOptionPane.showMessageDialog(null, "Campo vazio.", "ERRO: Campo vazio.",
							JOptionPane.ERROR_MESSAGE);
				} else {
					baseMaior = Double.parseDouble(cx1.getText());
					baseMenor = Double.parseDouble(cx2.getText());
					altura = Double.parseDouble(cx3.getText());
					
					area = ((baseMaior + baseMenor) * altura)/DIVISOR;
		...
		JLabel lblNewLabel_3_1 = new JLabel("Digite a base maior (B)");
		lblNewLabel_3_1.setFont(new Font("Poppins", Font.BOLD, 16));
		lblNewLabel_3_1.setBounds(398, 140, 190, 30);
		panel.add(lblNewLabel_3_1);
		
		cx1 = new JTextField();
		cx1.setFont(new Font("Poppins", Font.BOLD, 20));
		cx1.setColumns(10);
		cx1.setBounds(610, 137, 205, 40);
		panel.add(cx1);
		
		JLabel lblNewLabel_2 = new JLabel("");
		lblNewLabel_2.setIcon(new ImageIcon(Trapezio.class.getResource("/img/trapezio.png")));
		lblNewLabel_2.setBounds(10, 166, 366, 158);
