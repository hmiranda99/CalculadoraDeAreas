...
public class Circulo extends JFrame {
	...
	public Circulo() {
		...
		JLabel lblNewLabel_3 = new JLabel("Digite o raio (r)");
		...
		lblCrculo.setHorizontalAlignment(SwingConstants.CENTER);
		lblCrculo.setForeground(Color.WHITE);
		lblCrculo.setFont(new Font("Poppins", Font.BOLD, 20));
		lblCrculo.setBounds(305, 10, 204, 60);
		panel_1.add(lblCrculo);
		...
		lblNewLabel.setIcon(new ImageIcon(Circulo.class.getResource("/img/circulo.png")));
